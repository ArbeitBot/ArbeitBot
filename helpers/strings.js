...
module.exports = {
  ...
  selectCategoryMessage: 'Пожалуйста, выберите категорию вашего задания. The number of available contractors is displayed between [square brackets] for each category.',
  selectJobHourlyRateMessage: 'Укажате примерную цену, которую вы готовы заплатить. Конкретная цена обговаривается лично с исполнителем. The number of available contractors is displayed between [square brackets] for each rate range.',
  addJobDescriptionMessage: 'Пожалуйста, напишите ваше задание (максимум 500 знаков). Оно будет видно для исполнителей. Будьте кратки, детали обговариваются лично.',
  ...
  fullFreelancerMessageBusy: 'Ваш профиль заполненe! Однако, вам не будут приходить задания, пока ваш статус "Занят(а)".',
  emptyFreelancerMessage: 'Добро пожаловать в профиль! Пожалуйста, напишите информацию "О себе", выберите примерную сумму, за которую готовы работать а также категории заданий.',
  missingFreelancerMessage: 'Добро пожаловать в профиль! Пожалуйста, напишите информацию "О себе", выберите примерную сумму, за которую готовы работать а также категории заданий.',
